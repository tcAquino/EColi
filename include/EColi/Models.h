...
namespace ecoli
{
  namespace model_1
  {
    ...
    struct Parameters
    {
      ...
      static void parameter_list()
      {
        std::cout << "EColi : parameters:\n"
                  << "\ttime_w_diff             : Mean differsive residence time in water column\n"
                  << "\ttime_h_diff             : Mean differsive residence time in hyporheic zone\n"
    ...
    using HyporeicTransitionRegion_Surge = HyporheicTransitionRegion_Probability;
  ...
  namespace model_2
  {
    ...
    using MeanTime_WaterColumn_Surge = MeanTime_Quadratic;
    using MeanTime_Hyporheic_Adv_Surge = MeanTime_Linear;
    using HyporeicTransitionRegion_Surge = HyporheicTransitionRegion_Probability;
    using HyporeicTransitionRegion_Adv_Surge = HyporheicTransitionRegion_Resuspension;
